import time
from player import FirstPlayer, HumanPlayer
...
def play(game, XPlayer, OPlayer, letter, printGame = True):
...
if __name__ == "__main__":
    ...
    if firstPlayer.GetFirstPlayer() == "X":
        letter = "X"
    else:
        letter = "O"
    ...
    t = TicTacToe()
    play(t, XPlayer, OPlayer, letter, printGame = True)